...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,         KC_V,   KC_MPLY, KC_MUTE, KC_K,    KC_H,          KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
        MO(3),   KC_GRV,  KC_LALT, KC_LGUI, KC_LALT,      KC_SPC, MO(1),   MO(2),   KC_SPC,   LALT(KC_GRV), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
	[1] = LAYOUT(
