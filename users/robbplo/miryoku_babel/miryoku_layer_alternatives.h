...
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_SYM,KC_SPC),  LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              KC_DOT,            KC_0,              U_NA,              U_NA,              U_NA,              U_NP,              U_NP
